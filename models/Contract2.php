 ...
 */
class Contract2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['contract_type_id'], 'exist', 'skipOnError' => true, 'targetClass' => ContractContracttype::className(), 'targetAttribute' => ['contract_type_id' => 'id']],
            [['jabatan_id'], 'exist', 'skipOnError' => true, 'targetClass' => ContractJabatan::className(), 'targetAttribute' => ['jabatan_id' => 'id']],
            [['id_department'], 'exist', 'skipOnError' => true, 'targetClass' => Department::className(), 'targetAttribute' => ['id_department' => 'id']],
            [['employee_id'], 'exist', 'skipOnError' => true, 'targetClass' => EmployeeEmployee::className(), 'targetAttribute' => ['employee_id' => 'id']],
            [['project_id'], 'exist', 'skipOnError' => true, 'targetClass' => ProjectProject::className(), 'targetAttribute' => ['project_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(ContractContracttype::className(), ['id' => 'contract_type_id']);
    }
    ...
    {
        return $this->hasOne(ContractJabatan::className(), ['id' => 'jabatan_id']);
    }
    ...
    {
        return $this->hasOne(EmployeeEmployee::className(), ['id' => 'employee_id']);
    }
